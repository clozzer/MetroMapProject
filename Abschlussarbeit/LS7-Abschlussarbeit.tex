...
\newcommand \Autor{Robin M\"ohring}
\newcommand \Arbeitstitel{MetroMap-Layout-konforme Visualisierung von H\"ochstspannungsnetzen}
\newcommand \Erstgutachter{Prof.~Dr.~Heinrich~M\"uller}
\newcommand \Zweitgutachter{M.Sc.~Dominic~Siedhoff}
